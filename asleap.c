...
int main(int argc, char *argv[])
{
	...
	printf("Edited by Matt Moran to work with Windows. May or may not work.\n"
           "asleap %s - actively recover LEAP/PPTP passwords. "
	       "<jwright@hasborg.com>\n", VER);

	while ((c = getopt(argc, argv, "DsoavhVi:f:n:r:w:c:W:C:R:")) != EOF) {
		switch (c) {
		case 's':
